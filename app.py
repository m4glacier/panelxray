...
try:
    ...
    with open(html_path, "r", encoding="utf-8") as f:
        ...
        # Sisipkan nilai-nilai parameter ke dalam HTML (jika mau)
    ...
    st.error("⚠️ File `web/index.html` tidak ditemukan. Pastikan sudah diunggah ke folder yang sama di repo GitHub.")
